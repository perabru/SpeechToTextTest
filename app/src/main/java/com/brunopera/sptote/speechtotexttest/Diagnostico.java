...
public class Diagnostico extends AppCompatActivity{
    ...
    private void openMic(){
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT,"Olá, me fale o diagnóstico");
            ...
            case REQ_CODE_SPEECH_OUTPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    try {
                        ...
                        cbd.inserirDiagnostico(voiceInText.get(0));


                        Toast.makeText(getApplicationContext(), "Dados cadastrados com sucesso!", Toast.LENGTH_SHORT).show();

                    }catch(Exception ex){
                        Toast.makeText(getApplicationContext(), "Não foi possível gravar o Diagnóstico, tente de novo", Toast.LENGTH_SHORT).show();
                        openMic();
                        break;
                    }
                }

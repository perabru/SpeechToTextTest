...
public class Celular extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.celular);
        //openMic();
    ...
    private void openMic(){
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT,"Olá, qual seu celular?");
            ...
            case REQ_CODE_SPEECH_OUTPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    try {
                        ...
                        cbd.inserirCelular(voiceInText.get(0));


                        Toast.makeText(getApplicationContext(), "Dados cadastrados com sucesso!", Toast.LENGTH_SHORT).show();

                    }catch(Exception ex){
                        Toast.makeText(getApplicationContext(), "Não foi possível gravar o Celular, tente de novo", Toast.LENGTH_SHORT).show();
                        openMic();
                        break;
                    }
                }

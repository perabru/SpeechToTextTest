...
public class Bairro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bairro);
        openMic();
            ...
            case REQ_CODE_SPEECH_OUTPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    try {
                        ...
                        cbd.inserirBairro(voiceInText.get(0));

                        Toast.makeText(getApplicationContext(), "Dados cadastrados com sucesso!", Toast.LENGTH_SHORT).show();

                    }catch(Exception ex){
                        Toast.makeText(getApplicationContext(), "Não foi possível gravar o bairro, tente de novo", Toast.LENGTH_SHORT).show();
                        openMic();
                        break;
                    }
                }
